          ...
          <ModalBody>
            <Row>
              ...
              <Col md={6}sm={12}>
                ...
                {UserState.modalContent["Rank"] ? <span style={{display: 'block'}}><b>Rank:</b> {UserState.modalContent["Rank"]}</span> : null }
                {UserState.modalContent["Rank Points Bonus"] ? <span style={{display: 'block'}}><b>Rank Points Bonus:</b> {UserState.modalContent["Rank Points Bonus"]}</span> : null }
...
function RoutesList() {
  ...
  return ok_redirect ? <React.Fragment>
      ...
      <Route exact path="/:collection/rarity" component={Rarity} />
    </React.Fragment> : null
}
