...
function AdminAddresses (props) {
	...
	return <div>
		...
		<Row>
		<Col sm={12}>
			<MempoolTxs functions={['add-address-to-administrative','remove-address-from-adminstrative']} contract={window.RARITY_CONTRACT} />
		</Col>
		<Col lg={6} md={6} sm={12}>
