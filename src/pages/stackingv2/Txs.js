...
const Transactions = (props) => {
	...
	const location = useLocation();
  	...
  	const contract_id = window.STACKING_CONTRACT_V2;
  	...
  	const load = async (page = 1, cb = null) => {
		...
		let url = globals.STACKS_API_BASE_URL+"/extended/v1/address/"+window.STACKING_CONTRACT_V2+"/transactions?limit="+pagination+"&unanchored=true";
