...
function MinterAddresses (props) {
	...
	return <div>
		...
		<Row>
		<Col sm={12}>
			<MempoolTxs functions={['add-address-to-minter','remove-address-from-minter']} contract={window.TOKEN_CONTRACT} />
		</Col>
		<Col lg={6} md={6} sm={12}>
			<h3 className="subtitle no-border">Add minter addresses</h3>
		...
		<Col lg={6} md={6} sm={12}>
			<h3 className="subtitle no-border">Remove minter addresses</h3>
			<FormGroup floating style={{marginTop: 24}}>
...
export default MinterAddresses