...
const Transactions = (props) => {
	...
	const location = useLocation();
  	...
  	const contract_id = window.TOKEN_CONTRACT;
  	...
  	const load = async (page = 1, cb = null) => {
		...
		let url = globals.STACKS_API_BASE_URL+"/extended/v1/address/"+window.TOKEN_CONTRACT+"/transactions?limit="+pagination+"&unanchored=true";
