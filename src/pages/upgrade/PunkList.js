...
import PunkElement from './PunkElement';
...
function PunkList (props) {
	...
	const collection_name = window.UPGRADE_PUNK_CONTRACT + "::" + window.UPGRADE_PUNK_CONTRACT_TOKEN
	...
	return <div>
		...
		{
			nfts.map((nft,i,n) => {
				return <PunkElement key={"el_p_"+i}
					...
					ctx={{
						...
						token: window.UPGRADE_PUNK_CONTRACT_TOKEN
					}} />
			})
		}
		</Row>
